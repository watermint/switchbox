---
layout: command
title: Command `dev benchmark uploadlink`
lang: en
---
...
```
cd $HOME\Desktop
.\sbx.exe dev benchmark uploadlink -path /DROPBOX/PATH/TO/UPLOAD -size-kb NUM
```

macOS, Linux:
```
$HOME/Desktop/sbx dev benchmark uploadlink -path /DROPBOX/PATH/TO/UPLOAD -size-kb NUM
```
