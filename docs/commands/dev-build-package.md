---
layout: command
title: Command `dev build package`
lang: en
---
...
```
cd $HOME\Desktop
.\sbx.exe dev build package -build-path /LOCAL/PATH/TO/build -dist-path /LOCAL/PATH/TO/dist -platform PLATFORM_TYPE
```

macOS, Linux:
```
$HOME/Desktop/sbx dev build package -build-path /LOCAL/PATH/TO/build -dist-path /LOCAL/PATH/TO/dist -platform PLATFORM_TYPE
```
...
| `-executable-name` | Executable file name base               | sbx     |
