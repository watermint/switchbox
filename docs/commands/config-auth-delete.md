---
layout: command
title: Command `config auth delete`
lang: en
---
...
```
cd $HOME\Desktop
.\sbx.exe config auth delete -key-name KEY_NAME -peer-name PEER_NAME
```

macOS, Linux:
```
$HOME/Desktop/sbx config auth delete -key-name KEY_NAME -peer-name PEER_NAME
```
