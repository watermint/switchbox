---
layout: command
title: Command `dev release asset`
lang: en
---
...
```
cd $HOME\Desktop
.\sbx.exe dev release asset -owner REPOSITORY_OWNER -repo REPOSITORY_NAME -branch BRANCH -path URL_FILE_PATH -text TEXT_CONTENT -message COMMIT_MESSAGE
```

macOS, Linux:
```
$HOME/Desktop/sbx dev release asset -owner REPOSITORY_OWNER -repo REPOSITORY_NAME -branch BRANCH -path URL_FILE_PATH -text TEXT_CONTENT -message COMMIT_MESSAGE
```
