---
layout: command
title: Command `dev replay bundle`
lang: en
---
...
```
cd $HOME\Desktop
.\sbx.exe dev replay bundle -results-path /DROPBOX/PATH/TO/UPLOAD
```

macOS, Linux:
```
$HOME/Desktop/sbx dev replay bundle -results-path /DROPBOX/PATH/TO/UPLOAD
```
